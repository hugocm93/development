...
/* Define this if you have the resizeterm function in your ncurses-type
   library */
...
/* Define this if your curses library has use_default_colors, for cool
   transparency =-) */
...
#define HAVE__USR_LIB_KBD_CONSOLEFONTS 1
...
#define PACKAGE_STRING "cmatrix 2.0"
...
/* Define this if you want a character you pressed in the screensaver mode to
   retain in the terminal */
#define USE_TIOCSTI 1
